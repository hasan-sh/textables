...
function (_React$Component) {
  ...
  function Textables() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "search", function (search) {
      ...
      var test = _this.state.faces.map(function (face) {
        if (_typeof(face) === 'object') {
          return Object.create(face);
        }

        return face;
      });

      var searchedFaces = test.filter(function (face) {
      ...
      console.log(searchedFaces, faces);
...
//# sourceMappingURL=index.js.0720c07d3dedb0ece24b.hot-update.js.map